<template>
  <div id="add-blog">
      ...
      <form action="">
          ...
          <textarea v-model.lazy="blog.content" cols="30" rows="5"></textarea>
          <div id = "checkboxes">
              <label>Ninjas</label>
          ...
          <select v-model="blog.author">
            ...
            <option v-bind:key="author" v-for="author in authors" v-bind:value="author">{{author}}</option>
          </select>
